*******************************************************
SPECIFICATIONS AND DESCRIPTIONS FOR THE PARSING SCRIPTS
*******************************************************
***************
parseHeaders.py
***************
...
*|* Instructions *|*
=====================
input_directory = "path to the data files on your computer"
...
Ex: Epoch time(in microseconds) -> Year-Month-Day Hour-Minute-Second

*|* Instructions *|*
=====================
input_csv = "path to the csv containing the times in epoch line by line"
output_csv = "path to wherever you want the output datetime file to go"
...
=====================
input_directory = "path to the data files on your computer"
output_directory = "path to wherever you want the output file to go"
